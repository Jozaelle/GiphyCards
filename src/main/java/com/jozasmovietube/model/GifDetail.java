...
public class GifDetail {
    ...
    public GifDetail(String url, String giphyId, String rating, String description,
                     String title, String userName, int height, int width) {
    ...
    public GifDetail() { // default constructor
    }
    ...
    @Override
    public String toString() { // catch errors
        return "GifDetail{" +
                "id='" + id + '\'' +
                ", url='" + url + '\'' +
                ", giphyId='" + giphyId + '\'' +
